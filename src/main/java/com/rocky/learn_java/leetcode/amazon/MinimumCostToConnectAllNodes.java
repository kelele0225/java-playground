...
public class MinimumCostToConnectAllNodes {
	 ...
	 * Input:
	 * 
	 * n, an int representing the total number of nodes. edges, a list of integer
	 * pair representing the nodes already connected by an edge. newEdges, a list
	 * where each element is a triplet representing the pair of nodes between which
	 ...
	 * 10], [1, 6, 2], [5, 6, 5]] Output: 7 Explanation: There are 3 connected
	 * components [1, 4, 5], [2, 3] and [6].
	 * 
	 * We can connect these components into a single component by connecting node 1
	 * to node 2 and node 1 to node 6 at a minimum cost of 5 + 2 = 7.
	 */
	...
	public static void main(String[] args) {
		...
		Assert.assertEquals(7, MinimumCostToConnectAllNodes.solution(6, new int[][] { { 1, 4 }, { 4, 5 }, { 2, 3 } },
